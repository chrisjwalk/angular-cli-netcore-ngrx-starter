  ...
  template: `
    @if (loading()) {
      ...
      >
        ...
        <!-- Paginator -->
        <div
          class="flex items-center justify-between px-4 py-2 bg-surface-container-low"
        >
